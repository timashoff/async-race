...
export const createCarSVG = (id: number | string, color: string) => {
  const SVG_NS = 'http://www.w3.org/2000/svg';

  const svg = document.createElementNS(SVG_NS, 'svg');
  svg.innerHTML = `<g transform="translate(0,640) scale(0.1,-0.1)"  stroke="none">
  ...
  svg.setAttributeNS(null, 'width', '150pt');
  svg.setAttributeNS(null, 'height', '40pt');
  svg.setAttributeNS(null, 'viewBox', '350 10 1080 535');
  svg.id = `svg-${id}`;
